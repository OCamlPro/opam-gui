...
# -*- coding: utf-8 -*-
#
# opam-gui documentation build configuration file, created by
# sphinx-quickstart.
#
...
author = 'David Declerck <david.declerck@ocamlpro.com> & Fabrice Le Fessant <fabrice.le_fessant@origin-labs.com>'
...
latex_documents = [
    (master_doc, 'opam-gui.tex', 'opam-gui Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'opam-gui', 'opam-gui Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'opam-gui', 'opam-gui Documentation',
     author, 'opam-gui', 'One line description of project.',
     'Miscellaneous'),
]
